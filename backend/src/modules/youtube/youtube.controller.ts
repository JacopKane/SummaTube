...
export class YoutubeController {
    ...
    @Get("feed")
    async getUserFeed(@Req() req: Request): Promise<{ id: string; title: string; thumbnail: string; publishedAt: string; content: string | null; summaryStatus: string; videoUrl: string; }[]> {
